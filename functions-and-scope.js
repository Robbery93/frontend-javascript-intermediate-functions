...
const averageGradeRoundOff = gradesArray => {
    let total = 0;
...
console.log(averageGradeRoundOff(grades));
console.log(averageGradeRoundOff([6, 4, 5]));
console.log(averageGradeRoundOff([8, 9, 4, 6, 10]));
...
const highestGrade = gradesArray => {
    let highestGrade = 0;
    for (let i = 0; i < gradesArray.length; i++) {
